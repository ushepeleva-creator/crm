...
def add_client():
    ...
    new_client = {
        ...
        'visits': int(request.form.get('visits', 0) or 0),
        'avg_spent': int(request.form.get('avg_spent', 0) or 0),
        'last_visit_days': int(request.form.get('last_visit_days', 0) or 0)
    }
...
def appointments():
    ...
    return render_template('appointments.html', appointments=appointments_view, clients=data['clients'],
